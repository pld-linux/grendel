...
Summary(pl.UTF-8):   Napisany w Javie klient poczty/newsów
Name:		grendel
Version:	cvs
Release:	0.%{_snap}.1
License:	LGPL
...
Grendel to część pocztowo-newsowa projektu Xena napisana w Javie. Jej
celem jest bycie naprawdę przenośną aplikacją o możliwościach
satysfakcjonujących doświadczonego użytkownika.
